...
namespace EventStore.Projections.Core.Tests.Services.core_projection
{
    ...
    public class when_creating_a_projection
    {
        ...
        private readonly ProjectionConfig _defaultProjectionConfig = new ProjectionConfig(
            null, 5, 10, 1000, 250, true, true, true, true, true, false);
            ...
            )
        {
            ...
            var projectionConfig = new ProjectionConfig(null, 10, 5, 1000, 250, true, true, true, false, false, false);
        ...
        public void a_negative_checkpoint_handled_interval_throws_argument_out_of_range_exception()
        {
            IProjectionStateHandler projectionStateHandler = new FakeProjectionStateHandler();
            var version = new ProjectionVersion(1, 0, 0);
            var projectionConfig = new ProjectionConfig(null, -1, 10, 1000, 250, true, true, true, false, false, false);
            new ContinuousProjectionProcessingStrategy(
                "projection",
                version,
                projectionStateHandler,
        ...
        public void a_zero_checkpoint_handled_threshold_throws_argument_out_of_range_exception()
        {
            IProjectionStateHandler projectionStateHandler = new FakeProjectionStateHandler();
            var version = new ProjectionVersion(1, 0, 0);
            var projectionConfig = new ProjectionConfig(null, 0, 10, 1000, 250, true, true, true, false, false, false);
            new ContinuousProjectionProcessingStrategy(
                "projection",
                version,
                projectionStateHandler,
